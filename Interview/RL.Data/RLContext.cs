...
public class RLContext : DbContext
{
    ...
    public DbSet<UserPlanProcedureMapping> UserPlanProcedureMappings { get; set; }
    ...
    protected override async void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<UserPlanProcedureMapping>(typeBuilder =>
        {
            typeBuilder.HasKey(upm => upm.Id);
            typeBuilder.HasOne(upm => upm.User).WithMany(u => u.UserPlanProcedureMapping).HasForeignKey(upm => upm.UserId);
            typeBuilder.HasOne(upm => upm.PlanProcedure).WithMany(pp => pp.UserPlanProcedureMapping).HasForeignKey(upm => new { upm.PlanId, upm.ProcedureId });
        });
